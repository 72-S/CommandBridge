...
@Plugin(id = "commandbridge", name = "CommandBridgeVelocity", version = "1.6-SNAPSHOT", description = "A plugin to bridge commands between servers", authors = {"72S_"}, url = "https://modrinth.com/plugin/commandbridge")
